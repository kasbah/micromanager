...
#include "Hamamatsu.h"
#ifdef WIN32
#include "../../../3rdparty/Hamamatsu/DCAMSDK/201307/inc/dcamapix.h"
#include "../../../3rdparty/Hamamatsu/DCAMSDK/201307/inc/dcamprop.h"
// #include "../../../3rdparty/Hamamatsu/DCAMSDK/201307/inc/features.h"
...
MODULE_API void InitializeModuleData()
{
   ...
   RegisterDevice(g_DeviceName, MM::CameraDevice, "Universal adapter using DCAM interface");
}
   ...
   do
   {
      ...
      {            
         ...
         if (lnLastErr != ccErr_none)
         {
			...
			camera_->GetCoreCallback()->PostError(DEVICE_IMAGE_PARAMS_FAILED,"error in  dcam_wait");
